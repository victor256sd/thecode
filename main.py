...
st.info(":information_source: Click on the two arrows (>>) above for prompt writing pointers and other information in the sidebar.") #Access prompt writing pointers and other information in the sidebar.")
st.markdown(
    f"""
